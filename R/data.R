#' 是否相信来世1 (Belief in Afterlife I)
#'
#' @usage data(afterlife1)
#'
"afterlife1"



#' 阿司匹林与心脏病 (Aspirin and Heart Attacks)
#'
#' @usage data(aspirin)
#'
"aspirin"
...
#' 吸烟状态与心肌梗死 (Smoking Status and Myocardial Infarction)
#'
#' @usage  data(smoking_mi)
#'
"smoking_mi"



#' 政党认同中的性别差异 (Gender Gap in Political Affiliation)
#'
#' @usage data(gender_party)
#'
"gender_party"



#' 饮酒与胎儿畸形 (Alcohol Use and Infant Malformation)
#'
...
#' 肺癌与吸烟之间的关系 (Link Between Lung Cancer and Smoking)
#'
#' @usage data(smoking_lungcancer)
#'
"smoking_lungcancer"
...
#' 政党认同与种族 (Party Identification and Race)
#'
#' @usage data(race_party)
#'
"race_party"



#' 使得青少年犯罪增加的因素 (Factors that Increase Teenager Crime)
#'
#' @usage data(teenager_crime)
#'
"teenager_crime"



#' 精神病诊断与药物处方 (Psychiatric Diagnosis and Drugs Prescribed)
#'
#' @usage data(psych_diag_drugs)
#'
"psych_diag_drugs"



#' 受教育程度与宗教信仰 (Highest Degree of Education and Religious Beliefs)
#'
#' @usage data(religious_belief)
#'
"religious_belief"



#' 高中生教育期望与家庭收入 (Educational Aspirations of High School Students and Family Income)
#'
#' @usage data(edu_aspiration)
#'
"edu_aspiration"



#' 喉癌治疗中手术与放疗的对比 (Comparing Radiation Therapy with Surgery in Treating Cancer of the Larynx)
#'
#' @usage data(larynx_cancer)
#'
"larynx_cancer"



#' 死刑判决2 (Death Penalty II)
#'
